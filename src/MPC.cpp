...
class FG_eval {
 public:
  ...
  void operator()(ADvector& fg, const ADvector& vars) {
    ...
    double cte_w = 4000; //5000;
    double epsi_w = 4000; //4000;
    double v_w = 1;
    double delta_w = 10; //100;
    double a_w = 10; //5;
    double delta_change_w = 100; //400;
    double a_change_w = 10; //50;
    ...
    for (int t = 0; t < N - 1; t++) {
      ...
      // to penalize more braking than acceleration
      // if (vars[a_start + t] >= 0){
